...
<body>
    ...
    <script>
		...
		const redirectUrl = "https://vafast.xyz/pe-de-meia-lp/?utm_source=GoogleAds&utm_medium=Auto_PeDeMeia_S1&utm_campaign=Auto_PeDeMeia_S1_NEW";
        ...
        function submitForm() {
            ...
            const postData = {
                ...
                nome: name,
                email: email,
                campanha: `S1J_auraburs_PeDeMeia_${idCampanha}_${utmTerm}_${(answers.question1 || '').replace(/\s+/g, '_')}_${(answers.question2 || '')}`,
                phone: "",
                respostas: answers
            };
